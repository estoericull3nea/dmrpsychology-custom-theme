    ...
    <section class="about-hero-section">
        <div class="about-hero-container">
            <div class="about-hero-header">
                ...
                <p class="about-hero-description">DMR Psychological Services is committed to fostering mental health and
                    emotional well-being through compassionate, client-centered care.</p>
            ...
            <?php get_template_part('template-parts/portrait-gallery'); ?>
        </div>
    </section>
                ...
                <div class="service-section active" id="service-1">
                    <div class="service-section-inner">
                        <div class="service-text-block">
                            ...
                            <p class="service-description">The goal is to collaboratively help the client understand and
                                organize their mental space, set goals, and identify the necessary steps to accomplish
                                these goals, improve coping skills and resilience, and promote positive emotional change
                                and mental health.</p>
                        </div>
                ...
                <div class="service-section" id="service-2">
                    <div class="service-section-inner reverse">
                        ...
                        <div class="service-text-block">
                            ...
                            <p class="service-description">A process wherein the client answers a battery of tests.
                                These tests will be used to evaluate a person's behavior, abilities, and other
                                characteristics, particularly for the purposes of making a diagnosis or treatment
                                recommendation. This can also be used for the accomplishment of developmental forms and
                                and the issuance of a mental health clearance for students and employees.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="service-section" id="service-3">
                    <div class="service-section-inner">
                        <div class="service-text-block">
                            ...
                            <p class="service-description">Mental Health Training in the workplace acknowledges the
                                existence of different stressors in the employees' lives and teaches them better ways to
                                cope and address them to avoid the effects on their work performance. It aims to improve
                                the employee's productivity and performance, boost the company's identity and culture,
                                and reduce workplace conflict.</p>
                        </div>
                        <div class="service-visual-block">
    ...
    <section class="other-services-section">
        <div class="other-services-container">
            <div class="other-services-header">
                ...
                <p class="other-services-intro">The goal is to collaboratively help the client understand and organize
                    their mental space, set goals, and identify the necessary steps to accomplish these goals, improve
                    coping skills and resilience, and promote positive emotional change and mental health.</p>
            </div>
                ...
                <div class="other-service-card">
                    <div class="other-service-icon">
                        <svg width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M32 16L36 26L46 28L38 36L40 46L32 42L24 46L26 36L18 28L28 26L32 16Z"
